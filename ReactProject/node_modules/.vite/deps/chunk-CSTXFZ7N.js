...
var Tab = React10.forwardRef(function Tab2(inProps, ref) {
  ...
  return (0, import_jsx_runtime12.jsxs)(TabRoot, _extends({
    ...
    children: [iconPosition === "top" || iconPosition === "start" ? (0, import_jsx_runtime12.jsxs)(React10.Fragment, {
      children: [icon, label]
...
var Tabs = React15.forwardRef(function Tabs2(inProps, ref) {
  ...
  const children = React15.Children.map(childrenProp, (child) => {
    ...
    childIndex += 1;
    return React15.cloneElement(child, _extends({
...
//# sourceMappingURL=chunk-CSTXFZ7N.js.map
